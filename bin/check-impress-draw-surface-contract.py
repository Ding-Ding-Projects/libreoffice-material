...
``qa/windows-ui-contract/impress-draw-surfaces.json`` registers the Draw shell
surfaces from docs/design/11-impress-draw.md §11.2 -- the tool rail, the Fill/Line
property panel, and the status bar -- and this checker cross-validates each
...
REQUIRED_SURFACE_IDS = {"draw.tool-rail", "draw.property-panel", "draw.status-bar"}
