...
| WIN-INP-005 | search field and regex builder | no native owner assigned; prototype in `site` | prototype only | E-PROT | SRC, PX, MATRIX, FLOW, A11Y, LOC, PERF | `✓ · · · · · · · ·` |
| WIN-INP-006 | Find & Replace field set | `svx` dialog owner; regex builder unimplemented | upstream fields exist; Material composition target only | E-PROT | SRC, PX, MATRIX, FLOW, A11Y, LOC, COMPAT | `✓ · · · · · · · ·` |
...
| WIN-SHL-003 | notifications, infobars, snackbars | `sfx2/source/dialog/infobar.cxx`; snackbar owner unassigned | upstream infobar exists; Material composition incomplete | E-PROT | SRC, PX, MATRIX, FLOW, A11Y, LOC | `✓ · · · · · · · ·` |
...
| WIN-SYS-008 | onboarding/welcome | `cui/source/dialogs/welcomedlg.cxx`, `cui/uiconfig/ui/welcomedialog.ui` | Phase 6 target; upstream dialog only | none | D detail, SRC, PX, MATRIX, FLOW, A11Y, LOC | `△ · · · · · · · ·` |
...
| WIN-SYS-010 | migration and profile compatibility | `desktop/source/migration`, `framework`, `configmgr` | Phase 7 target; no Material surface inventory | none | D detail, SRC, MATRIX, FLOW, A11Y, LOC, PERF, COMPAT | `△ · · · · · · · ·` |
