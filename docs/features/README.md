...
| [`runtime-dialog-shells.md`](runtime-dialog-shells.md) | Material inset grids and fail-closed C++ page-host ownership for eighteen runtime-composed notebook shells. | Source contract + 20 mutation tests; **runtime UI UNVERIFIED**. |
