...
| [`runtime-dialog-shells.md`](runtime-dialog-shells.md) | Material inset grids and fail-closed C++ page-host ownership for twelve runtime-composed notebook shells. | Source contract + 18 mutation tests; **runtime UI UNVERIFIED**. |
