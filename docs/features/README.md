...
| [`runtime-dialog-shells.md`](runtime-dialog-shells.md) | Material inset grids and fail-closed C++ page-host ownership for eight runtime-composed notebook shells. | Source contract + 17 mutation tests; **runtime UI UNVERIFIED**. |
